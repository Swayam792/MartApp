...
initAdmin(); //Making axios post request for updating the cart
...
var deleteCartItem = function deleteCartItem(item) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/delete-cart-item', item).then(function (res) {
    ...
    document.location.reload(); // return res.redirect('/');
  })["catch"](function (err) {
    console.log(err);
    alert('something went wrong');
  });
